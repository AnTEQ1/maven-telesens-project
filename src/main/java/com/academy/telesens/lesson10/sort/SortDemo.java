...
public class SortDemo {
    public static void main(String[] args) {
        ...
        people.add(new Person("Vasia","Ivanov", 29, Gender.MALE));
        people.add(new Person("Sidor","Sidorov", 25, Gender.MALE));
        people.add(new Person("Helen","Petrjva", 27, Gender.FEMALE));
